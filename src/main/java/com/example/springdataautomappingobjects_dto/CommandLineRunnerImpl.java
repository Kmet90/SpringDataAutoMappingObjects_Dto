package com.example.springdataautomappingobjects_dto;
    ...
    public void run(String... args) throws Exception {
        ...
        while (true) {
            ...
            switch (commands[0]) {
                ...
                case "EditGame" -> {
                    String[] priceCommands = commands[2].split("=");
                    String[] sizeCommands = commands[3].split("=");
                    gameService
                            .editGame(Long.parseLong(commands[1]),
                                    new BigDecimal(priceCommands[1]),
                                    Double.parseDouble(sizeCommands[1]));
                }

                case  "DeleteGame" -> gameService
                        .deleteDame(Long.parseLong(commands[1]));
